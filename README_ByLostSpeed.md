...
![](README_ByLostSpeed.assets/my_logo.jpg)

## 编译环境搭建

[openpnp - 软件调试环境搭建](https://lostspeed.blog.csdn.net/article/details/128327493)

## 程序发布包的简易制作

[openpnp - 程序发布包的制作](https://lostspeed.blog.csdn.net/article/details/134073656)
...
[openpnp - src - 配置文件载入过程的初步分析](https://lostspeed.blog.csdn.net/article/details/134096650)